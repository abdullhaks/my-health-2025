...
export default class DoctorSessionController implements IDoctorSessionCtrl {
  ...
  async addSession(req: Request, res: Response): Promise<void> {
    try {
      ...
      const response = await this._doctorSessionService.addSession(
        sessionToAdd
      );
  ...
  async getSessions(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (doctorId) {
        const response = await this._doctorSessionService.getSessions(
          doctorId.toString()
        );
  ...
  async getBookedSlots(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (doctorId && selectedDate) {
        const response = await this._doctorSessionService.getBookedSlots(
          doctorId.toString(),
  ...
  async deleteSession(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (sessionId) {
        const response = await this._doctorSessionService.deleteSession(
          sessionId.toString()
        );
        res.status(HttpStatusCode.OK).json(response);
        return;
  ...
  async updateSession(req: Request, res: Response): Promise<void> {
    try {
      ...
      console.log(
        "sessionId and editingSession are:",
        sessionId,
        editingSession
      );
      ...
      const response = await this._doctorSessionService.updateSession(
        sessionId,
        editingSession
      );
  ...
  async makeDayUnavailable(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (doctorId && date) {
        const response = await this._doctorSessionService.makeDayUnavailable(
          doctorId,
          date
        );
        res.status(HttpStatusCode.OK).json(response);
  ...
  async getUnavailableDays(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (doctorId) {
        const response = await this._doctorSessionService.getUnavailableDays(
          doctorId.toString()
        );
        res.status(HttpStatusCode.OK).json(response);
        return;
  ...
  async unAvailableSessions(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (doctorId && date && sessionId) {
        const response = await this._doctorSessionService.unAvailableSessions(
          doctorId,
          date,
          sessionId
        );
  ...
  async getUnavailablSessions(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (doctorId) {
        const response = await this._doctorSessionService.getUnavailablSessions(
          doctorId.toString()
        );
        res.status(HttpStatusCode.OK).json(response);
        return;
